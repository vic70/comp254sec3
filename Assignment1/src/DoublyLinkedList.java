...
public class DoublyLinkedList<E> {
  ...
  /**
   * concatenating two doubly linked lists L and M, with header and trailer sentinel nodes, into a single list L′.
   * @param DoublyLinkedList<E>  the list to be concat to the end
   */
  public DoublyLinkedList<E> concatLists ( DoublyLinkedList<E> M){
...
//main method
  public static void main(String[] args)
  {
      ...
      DoublyLinkedList<String> L_p = L.concatLists(M);
